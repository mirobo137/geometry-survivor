...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 2026-08-26 | Android Chrome (modelo pendiente) | portrait | pendiente | 59.95 / 16.80 ms | 59.94 / 16.80 ms | 59.94 / 16.80 ms | `running`, 3.0 ms base | Ejecución limpia aportada por el usuario; la lectura previa de 76.11 FPS se descarta por ser transitoria |
