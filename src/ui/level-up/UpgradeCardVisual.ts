...
const UPGRADE_CARD_VISUALS: Record<UpgradeId, UpgradeCardVisual> = {
  ...
  overdrive_power_projectile: { icon: 'rail', tone: 'gold', category: 'OVERDRIVE · PROJECTILE' },
  overdrive_power_orbit: { icon: 'crown', tone: 'gold', category: 'OVERDRIVE · ÓRBITA' },
  overdrive_power_chain: { icon: 'thunder', tone: 'gold', category: 'OVERDRIVE · CADENA' },
  overdrive_power_boomerang: { icon: 'comet', tone: 'gold', category: 'OVERDRIVE · BÚMERAN' },
